...
{
    [Serializable]
    public class PickupGoalMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/PickupGoal";
        ...
        public static PickupGoalMsg Deserialize(MessageDeserializer deserializer) => new PickupGoalMsg(deserializer);

        private PickupGoalMsg(MessageDeserializer deserializer)
        {
