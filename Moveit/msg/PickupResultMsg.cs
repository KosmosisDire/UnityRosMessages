...
{
    [Serializable]
    public class PickupResultMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/PickupResult";
        ...
        public PickupResultMsg(MoveItErrorCodesMsg error_code, RobotStateMsg trajectory_start, RobotTrajectoryMsg[] trajectory_stages, string[] trajectory_descriptions, GraspMsg grasp, double planning_time)
        {
        ...
        public static PickupResultMsg Deserialize(MessageDeserializer deserializer) => new PickupResultMsg(deserializer);

        private PickupResultMsg(MessageDeserializer deserializer)
        {
