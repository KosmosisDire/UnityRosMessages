...
{
    [Serializable]
    public class PlaceGoalMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/PlaceGoal";
        ...
        public static PlaceGoalMsg Deserialize(MessageDeserializer deserializer) => new PlaceGoalMsg(deserializer);

        private PlaceGoalMsg(MessageDeserializer deserializer)
        {
