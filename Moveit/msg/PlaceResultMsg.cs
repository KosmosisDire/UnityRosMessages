...
{
    [Serializable]
    public class PlaceResultMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/PlaceResult";
        ...
        public PlaceResultMsg(MoveItErrorCodesMsg error_code, RobotStateMsg trajectory_start, RobotTrajectoryMsg[] trajectory_stages, string[] trajectory_descriptions, PlaceLocationMsg place_location, double planning_time)
        {
        ...
        public static PlaceResultMsg Deserialize(MessageDeserializer deserializer) => new PlaceResultMsg(deserializer);

        private PlaceResultMsg(MessageDeserializer deserializer)
        {
